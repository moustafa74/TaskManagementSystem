...
namespace TaskManagementSystem.Migrations
{
    ...
    [Migration("20240908035029_UpdateTaskAssignmentToMakeTeamAllowBeEmpty")]
    partial class UpdateTaskAssignmentToMakeTeamAllowBeEmpty
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManagementSystem.Models.TaskDependency", b =>
                {
                    ...
                    b.Property<int>("DependentTaskEntityId")
                        .HasColumnType("int");

                    b.HasKey("TaskEntityId", "DependentTaskEntityId");
            ...
            modelBuilder.Entity("TaskManagementSystem.Models.Attachment", b =>
                {
                    b.HasOne("TaskManagementSystem.Models.TaskEntity", "TaskEntity")
                        .WithMany("Attachments")
                        .HasForeignKey("TaskEntityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TaskManagementSystem.Models.ApplicationUser", "UploadedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("TaskManagementSystem.Models.TaskDependency", b =>
                {
                    b.HasOne("TaskManagementSystem.Models.TaskEntity", "DependentTaskEntity")
                        .WithMany()
                        .HasForeignKey("DependentTaskEntityId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("DependentTaskEntity");
